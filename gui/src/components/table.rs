...
impl UnitState {
    ...
    fn get_data(&self) -> (f64, String, String) {
        (
            *self.val.read(),
...
#[component]
fn RowUnitTable(on_remove: EventHandler, on_ok: EventHandler<(f64, String, String)>) -> Element {
...
pub fn UnitTable() -> Element {
    ...
    let handle_ok = move |(val, unit1, unit2): (f64, String, String)| {
        println!("Received: {}, {}, {}", val, unit1, unit2);
    };
